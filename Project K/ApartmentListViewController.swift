...
class AprtmentListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate,UISearchBarDelegate,DownloaderProtocal {
    ...
    @IBAction func refresh(sender: UIBarButtonItem) {
        ...
        let downloader = Downloader(cateid: 2)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cellIdentifier: String = "ApartmentBasicCell"
